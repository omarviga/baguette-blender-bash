	...
	theme: {
		...
		extend: {
			...
			transitionTimingFunction: {
				'smooth': 'cubic-bezier(0.68, -0.55, 0.265, 1.55)',
			...
			keyframes: {
				...
				'explode': {
					...
					'100%': {
						transform: 'translateY(var(--explode-distance)) scale(1.02)',
					}
				},
				'bounce-in': {
					'0%': {
			...
			animation: {
				...
				'explode': 'explode 0.6s cubic-bezier(0.68, -0.55, 0.265, 1.55)',
